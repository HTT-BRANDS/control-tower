...
- [x] **DoD-2**: `judge.py --env production` reports **>= 37/N** after Phase 2 adds checks (>= 71% coverage) -- 44/52 (85%), target well exceeded
...
Phase 2: [x][x][x][x][x][x][x][x][x][x][x][x][x][x][x][x][x][x]  (18/18) DONE
