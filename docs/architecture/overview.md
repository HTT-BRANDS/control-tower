...
> [**`current.md`**](https://github.com/HTT-BRANDS/control-tower/blob/main/docs/architecture/current.md).
>
...
> [`current.md`](https://github.com/HTT-BRANDS/control-tower/blob/main/docs/architecture/current.md#what-is-not-deployed-despite-appearing-in-target-diagrams) for the full gap list.
>
...
See dedicated [Security Guide](../authentication/) for complete details.
