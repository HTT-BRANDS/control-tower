...
2. **Dashboard** - Dashboard summary endpoints
3. **Costs** - Cost analysis and budget endpoints
4. **Compliance** - Compliance status and frameworks
5. **Resources** - Resource inventory management
6. **Identity** - User and group management
7. **Sync** - Data synchronization endpoints
