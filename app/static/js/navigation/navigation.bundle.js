            ...
            modal.innerHTML = `
                ...
                <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6 transform transition-all">
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 w-10 h-10 rounded-full bg-brand-error-5 flex items-center justify-center">
                            <svg class="w-6 h-6 text-danger" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                            </svg>
                        </div>
                        <div class="flex-1">
                            <h3 id="confirm-dialog-title" class="text-lg font-semibold text-primary-theme">Confirm Action</h3>
                            <p class="text-sm text-muted-theme mt-1">${escapeHtml(message)}</p>
                            <div class="flex justify-end gap-3 mt-6">
                                <button type="button" class="cancel-btn px-4 py-2 text-sm font-medium text-secondary-theme bg-surface-primary border border-border-default rounded-md hover:bg-surface-secondary focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-brand-primary-100">
                                    Cancel
                                </button>
                                <button type="button" class="confirm-btn px-4 py-2 text-sm font-medium text-white bg-brand-error-100 border border-transparent rounded-md hover:bg-brand-error-110 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-brand-error-100">
                                    Confirm
                                </button>
                            </div>
                        </div>
